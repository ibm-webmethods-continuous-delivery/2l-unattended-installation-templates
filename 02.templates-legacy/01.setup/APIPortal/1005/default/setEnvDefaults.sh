...
## Current Template
export WMUI_SETUP_TEMPLATE_YAP_LICENSE_FILE=${WMUI_SETUP_TEMPLATE_YAP_LICENSE_FILE:-"/provide/path/to/YAP-license.xml"}
...
export WMUI_SETUP_TEMPLATE_YAP_LICENSE_UrlEncoded=$(urlencode ${WMUI_SETUP_TEMPLATE_YAP_LICENSE_FILE})
