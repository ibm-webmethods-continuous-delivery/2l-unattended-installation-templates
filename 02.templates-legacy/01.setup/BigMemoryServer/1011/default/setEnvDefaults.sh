...
## Current Template
export WMUI_WMSCRIPT_TSALicenseFile=${WMUI_WMSCRIPT_TSALicenseFile:-"/provide/path/to/terracotta-license.key"}
export WMUI_WMSCRIPT_TSALicenseFile_UrlEncoded=$(urlencode ${WMUI_WMSCRIPT_TSALicenseFile})
# Section 2 - the caller MAY provide
## Framework - Install
export WMUI_INSTALL_INSTALL_DIR=${WMUI_INSTALL_INSTALL_DIR:-"/opt/sag/products"}
export WMUI_INSTALL_SPM_HTTPS_PORT=${WMUI_INSTALL_SPM_HTTPS_PORT:-"8093"}
export WMUI_INSTALL_SPM_HTTP_PORT=${WMUI_INSTALL_SPM_HTTP_PORT:-"8092"}
