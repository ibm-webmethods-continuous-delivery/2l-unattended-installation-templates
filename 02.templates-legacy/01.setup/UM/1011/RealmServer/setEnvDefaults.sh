...
## Template specific
export WMUI_WMSCRIPT_NUMDataDirID=${WMUI_WMSCRIPT_NUMDataDirID:-'/app/data'}
export WMUI_WMSCRIPT_NUMInterfacePortID=${WMUI_WMSCRIPT_NUMInterfacePortID:-9000}
export WMUI_WMSCRIPT_NUMRealmServerNameID=${WMUI_WMSCRIPT_NUMRealmServerNameID:-'umserver'}
