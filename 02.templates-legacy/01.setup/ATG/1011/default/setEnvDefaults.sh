...
export WMUI_SETUP_TEMPLATE_MFTSERVER_LICENSE_FILE=${WMUI_SETUP_TEMPLATE_MFT_GTW_LICENSE_FILE:-"/provide/path/to/MFTGTW-license.xml"}
...
export WMUI_INSTALL_IS_MAIN_HTTPS_PORT=${WMUI_INSTALL_IS_MAIN_HTTPS_PORT:-"5543"}
...
export WMUI_SETUP_TEMPLATE_IS_LICENSE_FILE_UrlEncoded=$(urlencode ${WMUI_SETUP_TEMPLATE_IS_LICENSE_FILE})
export WMUI_SETUP_TEMPLATE_MFT_GTW_LICENSE_FILE_UrlEncoded=$(urlencode ${WMUI_SETUP_TEMPLATE_MFT_GTW_LICENSE_FILE})
