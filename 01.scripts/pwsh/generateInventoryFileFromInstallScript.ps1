param (${file}, ${outFile}, ${sumVersionString}="10.5.0", ${sumPlatformString}="LNXAMD64", ${WMUI_VersionString}="1005", ${updateManagerVersion}="11.0.0.0000-0117", ${SumPlatformGroupString}="""UNX-ANY"",""LNX-ANY""")
