...
This is a test harness for the container build template `05.container-image-builders/DESIGNER/1101/esb-01/ubi-min` that relies on the template `DESIGNER/1101/esb-01`.
