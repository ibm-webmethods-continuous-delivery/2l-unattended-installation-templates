...
6. Open a browser to [localhost API Gateway UI](http://localhost:44272), or better to [host.docker.internal API Gateway UI](http://host.docker.internal:44272)
7. If you want to inspect Elasticsearch contents, go to [elasicvue home](http://host.docker.internal:44280) and then point to the ES instance at http://host.docker.internal:44220
