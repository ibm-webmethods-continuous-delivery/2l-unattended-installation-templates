...
export WMUI_TEST_HARNESS_FOLDER="03.test/APIGateway/1101/cds-e2e-postgres/wmui-agw-cds-e2e-postgres-1101-test-01"
...
setupAPIGateway() {
  ...
  # Check if API Gateway is already installed__err_count
