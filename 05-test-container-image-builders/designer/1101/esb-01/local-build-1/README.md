...
This is a test harness for the container build template `04-container-image-builders/designer/1101/esb-01/ubi-min` that relies on the template `designer/1101/esb-01`.
